...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::rnappleintelligence::ToolDefinition> final {
    static inline margelo::nitro::rnappleintelligence::ToolDefinition fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::rnappleintelligence::ToolDefinition(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::rnappleintelligence::ToolDefinition& arg) {
